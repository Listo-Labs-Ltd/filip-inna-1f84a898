...
import { mcpRoutes, seedStoreConfig, seedObservability } from "./routes/mcp.js";
...
async function main() {
  ...
  try {
    ...
    const storeConfig = StoreConfigSchema.parse({
      ...
      tenantId: "596c12e6-9287-4761-8eaf-c33facf22037",
      businessName: "filip+inna",
      displayName: "filip+inna",
    ...
    const observability = createMcpObservabilityEasy({ serviceName: SVC_NAME });
    seedObservability(observability);
